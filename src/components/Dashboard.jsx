...
export default function Dashboard(props) {
    ...
    return (
        <div>
            ...
            <p className='flex justify-center items-center my-6 mx-auto text-4xl font-poppins font-semibold'>Welcome to SkyCast</p>
            ...
            <div className='flex justify-center items-center mt-8 mx-auto h-20 w-3/5 bg-gray-200 rounded-2xl drop-shadow-lg'>
                <form onSubmit={props.submitLocation} autoComplete='off'>
                    <label htmlFor="location-search" className='text-lg font-poppins'>Enter Location:</label>
                    <input type="text" id='location-search' placeholder='e.g. New York, NY' onChange={props.handleChange} className='ml-2 h-8 w-72 rounded-2xl border-transparent indent-4 focus:outline-none'/>
                </form>
            </div>
